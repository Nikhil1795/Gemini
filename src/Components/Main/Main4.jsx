// // 3rd JS file: Uses custom question first and then search on google to give response
// // uses fuse.js to understand the question and give precise answers from the lists of questions and using sysnonyms
...
//         const fuse = new Fuse(customQA, { keys: ["question"], threshold: 0.4 });
//         const customQuestions = fuse.search(normalized);

//         if (customQuestions.length > 0) {
//             setAnswer(customQuestions[0].item.answer);
//             setLoading(false);
//             return;
//         }
